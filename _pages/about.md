...
Along with my work at ETH, I've done PhD research internships in the areas of semiconductor simulation development (at the **Samsung Semiconductor** [Device Lab](https://semiconductor.samsung.com/us/about-us/us-office/us-r-and-d-labs/innovation-center/), in San Jose, CA) and ML foundation models for materials (at **Meta's Fundamental AI Research [(FAIR) - Chemistry](https://ai.meta.com/research/impact/open-catalyst/)** team, San Francisco, CA - ongoing). It's a lot of fun to work on state-of-the art research in teams of brilliant PhD researchers and engineers with industry resources at hand.
