...
I could really take advantage of this increased partitipation to deliver a version of the course that would really only work there: Digital Electronics, is, fundamentally, logical. Given the building blocks and a shove in the right direction, you can derive the entire thing yourself. If you know how logic gates work, and you know how to add numbers in binary, it doesn't take much thought to design adders. If you understand the concept of feedback, it's straightforward to design all the flip flop circuits that we learn about. Enabling 20+ motivated students to re-derive a lot of the basics of digital logic this way was immensely satisfying.
